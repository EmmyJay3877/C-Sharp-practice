...
namespace DemoLibrary
{
    ...
    {
        public event EventHandler MakePaymentEvent;

        public event EventHandler<decimal> ErrorMsgEvent;

        public event EventHandler InsufficientAlertEvent;
        ...
        public bool AddDeposit(string depositName, decimal amount)
        {
            ...
            Balance += amount;
            MakePaymentEvent?.Invoke(this, new EventArgs());
            return true;
        }
            ...
            else
            {
                ...
                if (backupAccount != null)
                {
                    ...
                    if ((backupAccount.Balance + Balance) > amount)
                    {
                        ...
                        ErrorMsgEvent?.Invoke(this, amountNeeded);
                    ...
                    {
                        InsufficientAlertEvent?.Invoke(this, new EventArgs());
                        return false;
                    }
                }
                else
